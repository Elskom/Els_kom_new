...
Module Module2
	...
	Public Function KillApp(ByRef myName As String) As Boolean
...
#Enable Warning BC42353
	...
	Function KillProcess(ByVal hProcessID As Integer, Optional ByVal exitCode As Integer = 0) As Boolean
