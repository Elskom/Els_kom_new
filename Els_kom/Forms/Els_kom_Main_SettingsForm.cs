    ...
    internal partial class SettingsForm : Form
    {
        ...
        private void SettingsForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (!string.Equals(this.TextBox1.Text, this.curvalue3))
            {
                ...
                {
                    MessageManager.ShowWarning("You Should Set a Working Elsword Directory.", "Warning!", Convert.ToBoolean(Convert.ToInt32(SettingsFile.Settingsxml?.TryRead("UseNotifications") != string.Empty ? SettingsFile.Settingsxml?.TryRead("UseNotifications") : "0")));
                }
            }
            ...
            for (var i = 0; i < this.ListView1.SelectedItems.Count; i++)
            {
                ...
                foreach (var callbackplugin in KOMManager.Callbackplugins)
                {
                    if (callbackplugin.PluginName.Equals(selitem.Text))
                    {
                        ...
                        plugsettingfrm.ShowDialog(callbackplugin.ShowModal ? this : null);
                    }
                }
            }
        }
