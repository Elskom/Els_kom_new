...
namespace Els_kom_Core.Classes
{
    ...
    public sealed class XMLObject : IDisposable
    {
        ...
        /// </summary>
        /// <value>
        /// A value indicating whether the <see cref="XMLObject"/> is disposed.
        /// </value>
        public bool IsDisposed => this.xmlObject.IsDisposed;
        ...
        /// </summary>
        public void Dispose() => this.xmlObject.Dispose();
    }
}
