...
namespace Els_kom_Core.Classes
{
    ...
    public sealed class BlowFish: System.IDisposable
    {
        ...
        System.Security.Cryptography.RNGCryptoServiceProvider randomSource;
        ...
        {
            randomSource = new System.Security.Cryptography.RNGCryptoServiceProvider();
        ...
        public string Decrypt_CBC(string ct)
        {
            ...
            return System.Text.Encoding.ASCII.GetString(Decrypt_CBC(HexToByte(ct.Substring(16)))).Replace("\0", "");
        }
        ...
        private void SetBlock(byte[] block)
        {
            ...
            else
            {
                ...
                xl_par = System.BitConverter.ToUInt32(block1, 0);
                xr_par = System.BitConverter.ToUInt32(block2, 0);
            }
        }
        ...
        private void GetBlock(ref byte[] block)
        {
            ...
            {
                block1 = System.BitConverter.GetBytes(xl_par);
                block2 = System.BitConverter.GetBytes(xr_par);
