...
Els_kom_Wrapper_Extern unsigned char* Unpack_KOM_Generic(std::string FileName, unsigned char* FileData, std::string DestPath, int Alg);
Els_kom_Wrapper_Extern unsigned char* Pack_KOM_Generic(unsigned char* FileData, int Alg);
#endif
